...
const Banner = () => {
    return (
        <div>
            <div className="hero h-[500px] bg-base-200 object-cover" style={{backgroundImage: 'url(/src/assets/inage/banner1.jpg)'}}>
                <div className="hero-content grid grid-cols-4">
                  
                    <div className="col-span-2">
                        <p className="text-orange-600">Today</p>
                        <h1 className="text-5xl  text-orange-600 font-medium">Speacial Menu</h1>
