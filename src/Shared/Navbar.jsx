...
const Navbar = () => {
    ...
    return (
        ...
        <div className="navbar bg-orange-400 shadow-md">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost normal-case text-xl">Cook Foods</a>
            </div>
            ...
            <div className="navbar-end">
               ...
               <div className="border rounded-md flex items-center gap-4 justify-center ">
                 
               <button className="p-1" onClick={handleLogout}><span className="flex items-center gap-1 justify-center">Logout<BiLogOut></BiLogOut> </span></button>
